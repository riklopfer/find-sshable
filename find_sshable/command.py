...
def main(argv):
    ...
    parser.add_argument('--intrusive',
                        help="Check that there is a valid ssh auth method available on the host.",
                        action='store_true')
    ...
    pi_addrs = net.find_sshable(host_pattern=host_pattern, intrusive=intrusive)
    if pi_addrs:
        print(
            "\nFound {} devices...\n"
